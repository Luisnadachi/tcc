    ...
    Private Sub btn_Atualizar_Click(sender As Object, e As EventArgs) Handles btn_Atualizar.Click
        ...
        If MessageBox.Show("Você tem certeza que deseja atualizar esse cadastro?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) = DialogResult.Yes Then
            ...
            Try
                ...
                sql = "UPDATE Fornecedores SET nome_Fornec = '" & TextBoxNomeForne.Text & "', cnpj_Fornec = '" & MaskedTextBoxCNPJForne.Text & "', informacoes_ad_Fornec = '" & TextBoxinformacaoForn.Text & "', email_Fornec = '" & TextBoxEMAILForn.Text & "', celular_Fornec = '" & MaskedTextBoxCEL1Forn.Text & "', telefone_Fornec = '" & MaskedTextBoxTEL1Forn.Text & "', logradouro_Fornec = '" & TextBoxLogradouroForn.Text & "', numero_end_Fornec = '" & TextBoxNumForn.Text & "',  bairro_Fornec = '" & TextBoxBairroForn.Text & "',  complemento_Fornec = '" & TextBoxCompleForn.Text & "',  cep_Fornec = '" & MaskedTextBoxCEPForn.Text & "',  cidade_Fornec = '" & TextBoxCidadeForn.Text & "',  estado_Fornec = '" & TextBoxUfForn.Text & "', agencia_Fornec = '" & TextBoxAgenciaForn.Text & "',  conta_Fornec = '" & TextBoxContaBancoForn.Text & "',  operacao_Fornec = '" & TextBoxOperacaoBancoForn.Text & "', banco_Fornec = '" & ComboBoxBancoForn.Text & "' WHERE id_Fornec = " + TextBoxIdForne.Text
